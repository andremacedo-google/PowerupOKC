---
id: AP-011
name: "CIS - Sistema de Faturamento Comercial"
type: "Application"
...
# CIS - Sistema de Faturamento Comercial (ID: AP-011)

Este Fact Sheet de **Business Application** descreve no padrão de arquitetura empresarial da **SAP LeanIX v4** o escopo de atuação e barramento de dados do sistema **CIS - Sistema de Faturamento Comercial** [13, 33]. Ele atua como um pilar fundamental da camada de aplicação e dados da companhia, estruturando as operações no Setor Elétrico Brasileiro [13, 34].
...
*   **Core transacional comercial elétrico responsável pelo cálculo tarifário complexo, encargos regulados ANEEL, processamento do faturamento massivo e gestão de inadimplência (FI-CA).** [33, 438]
...
*   **Inputs (Dados de Entrada consumidos):**
    *   `[/data-objects/do-009-histórico-de-consumo-e-geração.md](DO-009 Histórico de Consumo e Geração)`
    *   `[/data-objects/do-008-cadastro-de-prossumidor.md](DO-008 Cadastro de Prossumidor)` [31, 34]
*   **Outputs (Dados de Saída fornecidos ou gravados):**
    *   `[/data-objects/do-010-fatura-de-energia-conta-de-luz.md](DO-010 Fatura de Energia (Conta de Luz))` [31, 34]
...
*   `[/business-capabilities/cap-l3-processamento-de-faturas.md](Processamento De Faturas)`
*   `[/business-capabilities/cap-l3-onboarding-de-clientes.md](Onboarding De Clientes)`
*   `[/business-capabilities/cap-l3-gestao-de-inadimplencia.md](Gestao De Inadimplencia)` [21, 129]
...
*   **SAP IS-U / CCS, Oracle Utilities Customer Cloud Service (CCS)** [35, 338]
