...
Este Fact Sheet de **Business Application** descreve no padrão de arquitetura empresarial da **SAP LeanIX v4** o escopo de atuação e barramento de dados do sistema **CLM - Gestão do Ciclo de Vida de Contratos** [13, 33]. Ele atua como um pilar fundamental da camada de aplicação e dados da companhia, estruturando as operações no Setor Elétrico Brasileiro [13, 34].
...
*   **Sistema corporativo para gestão do ciclo de vida de contratos com fornecedores, empreiteiras de obras EPC, contratos de conexão de uso do sistema (CUSD/CUST) e contratos bilaterais (PPAs).** [33, 438]
...
*   **Outputs (Dados de Saída fornecidos ou gravados):**
    *   `[/data-objects/do-013-minutas-e-termos-contratuais-contratos-ativos-e-workflows-de-assinatura.md](DO-013 Minutas e Termos Contratuais (Contratos Ativos e Workflows de Assinatura))` [31, 34]
...
*   `[/business-capabilities/cap-l3-gestao-de-contratos.md](Gestao De Contratos)` [21, 129]
...
*   **SAP S/4HANA (CLM/ECM), Icertis CLM, DocuSign CLM** [35, 338]
