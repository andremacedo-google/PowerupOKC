...
# GIS - Sistema de Informação Geográfica de Redes (ID: AP-015)

Este Fact Sheet de **Business Application** descreve no padrão de arquitetura empresarial da **SAP LeanIX v4** o escopo de atuação e barramento de dados do sistema **GIS - Sistema de Informação Geográfica de Redes** [13, 33]. Ele atua como um pilar fundamental da camada de aplicação e dados da companhia, estruturando as operações no Setor Elétrico Brasileiro [13, 34].
...
*   **Sistema autoritativo georreferenciado que modela a topologia geográfica completa das redes de média e baixa tensão e serve de base técnica para a BDGD da ANEEL.** [33, 438]
...
*   **Outputs (Dados de Saída fornecidos ou gravados):**
    *   `[/data-objects/do-002-cadastro-georreferenciado-de-rede-gis-estrutura-física-espacial.md](DO-002 Cadastro Georreferenciado de Rede (GIS) (Estrutura Física Espacial))` [31, 34]
...
*   `[/business-capabilities/cap-l3-gestao-de-dados-da-rede.md](Gestao De Dados Da Rede)`
*   `[/business-capabilities/cap-l3-planejamento-da-expansao-da-rede.md](Planejamento Da Expansao Da Rede)` [21, 129]
...
*   **Esri ArcGIS Utility Network, GE Smallworld GIS, Intergraph** [35, 338]
