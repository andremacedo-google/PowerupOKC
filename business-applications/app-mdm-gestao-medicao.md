...
# MDM - Gestão de Dados de Medição (ID: AP-012)

Este Fact Sheet de **Business Application** descreve no padrão de arquitetura empresarial da **SAP LeanIX v4** o escopo de atuação e barramento de dados do sistema **MDM - Gestão de Dados de Medição** [13, 33]. Ele atua como um pilar fundamental da camada de aplicação e dados da companhia, estruturando as operações no Setor Elétrico Brasileiro [13, 34].
...
*   **Repositório central de telemetria de medidores inteligentes (AMI) que purifica bilhões de leituras brutas através do motor de Validação, Edição e Estimativa (VEE) para faturamento e gestão de fraudes.** [33, 438]
...
*   **Inputs (Dados de Entrada consumidos):**
    *   `[/data-objects/do-001-leituras-de-telemetria-ami.md](DO-001 Leituras de Telemetria (AMI))` [31, 34]
*   **Outputs (Dados de Saída fornecidos ou gravados):**
    *   `[/data-objects/do-009-histórico-de-consumo-e-geração-leituras-validadas.md](DO-009 Histórico de Consumo e Geração (Leituras Validadas))` [31, 34]
...
*   `[/business-capabilities/cap-l3-medicao-e-coleta-de-dados.md](Medicao E Coleta De Dados)`
*   `[/business-capabilities/cap-l3-gestao-de-perdas.md](Gestao De Perdas)` [21, 129]
...
*   **Oracle Utilities MDM, Siemens EnergyIP, Landis+Gyr Command Center** [35, 338]
