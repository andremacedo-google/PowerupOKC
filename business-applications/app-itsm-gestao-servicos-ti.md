---
id: AP-007
name: "ITSM / ITOM - Gestão de Serviços e Operações de TI"
type: "Application"
...
# ITSM / ITOM - Gestão de Serviços e Operações de TI (ID: AP-007)

Este Fact Sheet de **Business Application** descreve no padrão de arquitetura empresarial da **SAP LeanIX v4** o escopo de atuação e barramento de dados do sistema **ITSM / ITOM - Gestão de Serviços e Operações de TI** [13, 33]. Ele atua como um pilar fundamental da camada de aplicação e dados da companhia, estruturando as operações no Setor Elétrico Brasileiro [13, 34].
...
*   **Plataforma integrada de ITSM e ITOM para gestão de incidentes corporativos, requisições de mudanças e manutenção do CMDB convergente entre ativos de TI e Tecnologia da Operação (SCADA/DMS).** [33, 438]
...
*   **Inputs (Dados de Entrada consumidos):**
    *   `[/data-objects/do-017-logs-de-redes-e-acessos-soc.md](DO-017 Logs de Redes e Acessos (SOC))` [31, 34]
*   **Outputs (Dados de Saída fornecidos ou gravados):**
    *   `[/data-objects/do-018-catálogo-de-apis-e-dependências.md](DO-018 Catálogo de APIs e Dependências)` [31, 34]
...
*   `[/business-capabilities/cap-l3-gestao-de-infraestrutura-e-operacoes-de-ti.md](Gestao De Infraestrutura E Operacoes De Ti)` [21, 129]
...
*   **ServiceNow (ITSM/ITOM), Jira Service Management, BMC Helix** [35, 338]
