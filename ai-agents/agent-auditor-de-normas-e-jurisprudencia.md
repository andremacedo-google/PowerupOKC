---
id: IAA-046
name: "Auditor de Normas e Jurisprudência"
type: "Application"
subtype: "AI Agent"
lifecycle:
  status: "Active"
...
# Auditor de Normas e Jurisprudência (IAA-046)

Este documento apresenta a especificação técnica e as instruções do sistema no padrão **OKF (Open Knowledge Format) v0.1** para o agente cognitivo **Auditor de Normas e Jurisprudência**, integrado ao catálogo de arquitetura **PowerUp OKC (Open Knowledge Catalog)** seguindo as diretrizes de modelagem de EA da **SAP LeanIX v4**.

---

## 1. Descrição do Agente

O agente **Auditor de Normas e Jurisprudência** é classificado arquiteturalmente como um **No-code Agent** e atua no suporte de fluxos operacionais com a responsabilidade principal de **Cognitivo (RAG)**. 

Sua missão de negócio é:
> Monitora continuamente resoluções, despachos e diários oficiais de órgãos reguladores (ANEEL, CCEE, ONS), sintetizando entendimentos aplicáveis e jurisprudência para subsidiar o consultivo.
...
3. Prover suporte consultivo e tomadas de decisões rápidas de primeiro nível para o papel organizacional de **Especialista em Regulação / Advogado Regulatório**.

### **Tarefas de Execução**
1. **Consumo de Entradas:** Ler e processar de forma estruturada os seguintes objetos de dados associados: `Leis e Decretos Setoriais, PRODIST, PRORET`.
2. **Integração e SOT:** Sincronizar logs, cadastros, e interações na aplicação core de registro que atua como **System of Truth (SOT)** canônico: **Biblioteca da ANEEL / GED Regulatório**.
...
* **Business Capability (Nível 3):** `[/business-capabilities/cap-conformidade-regulatoria.md]`
* **Organization User Group (Team):** `[/organizations/teams/org-especialista-em-regulacao.md]`
* **Data Objects Relacionados:** `[/data-objects/do-generic.md]`
* **Business Application (System of Truth - SOT):** `[/business-applications/app-biblioteca-da-aneel-ged-regulatorio.md]`

---

## 5. Personalização (Sugestões de Conversa)

1. *"Como o Auditor de Normas e Jurisprudência realiza suas tarefas?"*
2. *"Quais os dados necessarios para iniciar o Auditor de Normas e Jurisprudência?"*
3. *"Gerar um relatorio de analise do Auditor de Normas e Jurisprudência."*
