---
id: IAA-021
name: "Triador de Currículos e Perfis"
type: "Application"
subtype: "AI Agent"
lifecycle:
  status: "Active"
...
# Triador de Currículos e Perfis (IAA-021)

Este documento apresenta a especificação técnica e as instruções do sistema no padrão **OKF (Open Knowledge Format) v0.1** para o agente cognitivo **Triador de Currículos e Perfis**, integrado ao catálogo de arquitetura **PowerUp OKC (Open Knowledge Catalog)** seguindo as diretrizes de modelagem de EA da **SAP LeanIX v4**.

---

## 1. Descrição do Agente

O agente **Triador de Currículos e Perfis** é classificado arquiteturalmente como um **No-code Agent** e atua no suporte de fluxos operacionais com a responsabilidade principal de **Cognitivo (OCR/NLP)**. 

Sua missão de negócio é:
> Processa e extrai entidades de currículos recebidos (PDF/DOCX) via OCR, realizando triagem técnica e ranqueamento de candidatos contra os requisitos mínimos da vaga.
...
3. Prover suporte consultivo e tomadas de decisões rápidas de primeiro nível para o papel organizacional de **Recrutador Técnico / Analista de Seleção**.

### **Tarefas de Execução**
1. **Consumo de Entradas:** Ler e processar de forma estruturada os seguintes objetos de dados associados: `Currículos dos Candidatos, Requisição de Vaga`.
...
* **Business Capability (Nível 3):** `[/business-capabilities/cap-sourcing-de-talentos-recrutamento.md]`
...
1. *"Como o Triador de Currículos e Perfis realiza suas tarefas?"*
2. *"Quais os dados necessarios para iniciar o Triador de Currículos e Perfis?"*
3. *"Gerar um relatorio de analise do Triador de Currículos e Perfis."*
