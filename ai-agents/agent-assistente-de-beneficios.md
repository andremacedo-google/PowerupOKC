...
# Assistente de Benefícios (IAA-019)

Este documento apresenta a especificação técnica e as instruções do sistema no padrão **OKF (Open Knowledge Format) v0.1** para o agente cognitivo **Assistente de Benefícios**, integrado ao catálogo de arquitetura **PowerUp OKC (Open Knowledge Catalog)** seguindo as diretrizes de modelagem de EA da **SAP LeanIX v4**.

---

## 1. Descrição do Agente

O agente **Assistente de Benefícios** é classificado arquiteturalmente como um **No-code Agent** e atua no suporte de fluxos operacionais com a responsabilidade principal de **Read (R)**. 

Sua missão de negócio é:
> Consulta de elegibilidade e cobertura de planos de previdência privada, saúde e coparticipações vigentes, gerando extratos automáticos de reembolso para funcionários.
...
3. Prover suporte consultivo e tomadas de decisões rápidas de primeiro nível para o papel organizacional de **Analista de Benefícios / Colaborador**.

### **Tarefas de Execução**
1. **Consumo de Entradas:** Ler e processar de forma estruturada os seguintes objetos de dados associados: `Plano de Benefícios, Dependentes`.
...
* **Business Capability (Nível 3):** `[/business-capabilities/cap-administracao-de-funcionarios-gestao-de-reembolso.md]`
* **Organization User Group (Team):** `[/organizations/teams/org-analista-de-beneficios.md]`
...
1. *"Como o Assistente de Benefícios realiza suas tarefas?"*
2. *"Quais os dados necessarios para iniciar o Assistente de Benefícios?"*
3. *"Gerar um relatorio de analise do Assistente de Benefícios."*
