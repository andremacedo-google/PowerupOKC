---
id: IAA-042
name: "Conciliador de Despesas de Escritórios"
type: "Application"
subtype: "AI Agent"
lifecycle:
  status: "Active"
...
# Conciliador de Despesas de Escritórios (IAA-042)

Este documento apresenta a especificação técnica e as instruções do sistema no padrão **OKF (Open Knowledge Format) v0.1** para o agente cognitivo **Conciliador de Despesas de Escritórios**, integrado ao catálogo de arquitetura **PowerUp OKC (Open Knowledge Catalog)** seguindo as diretrizes de modelagem de EA da **SAP LeanIX v4**.

---

## 1. Descrição do Agente

O agente **Conciliador de Despesas de Escritórios** é classificado arquiteturalmente como um **Data Agent** e atua no suporte de fluxos operacionais com a responsabilidade principal de **Read / Update (R/U)**. 

Sua missão de negócio é:
> Realiza a conciliação transacional estruturada entre as faturas físicas (time-sheets) enviadas por escritórios parceiros e os limites contratuais do ERP.
...
3. Prover suporte consultivo e tomadas de decisões rápidas de primeiro nível para o papel organizacional de **Gerente Jurídico / Analista de Risco e Compliance**.

### **Tarefas de Execução**
1. **Consumo de Entradas:** Ler e processar de forma estruturada os seguintes objetos de dados associados: `Fatura de Fornecedor, Fornecedor (DO-169)`.
2. **Integração e SOT:** Sincronizar logs, cadastros, e interações na aplicação core de registro que atua como **System of Truth (SOT)** canônico: **SAP FI-AP**.
...
* **Organization User Group (Team):** `[/organizations/teams/org-gerente-juridico.md]`
* **Data Objects Relacionados:** `[/data-objects/do-169.md]`
* **Business Application (System of Truth - SOT):** `[/business-applications/app-sap-fi-ap.md]`

---

## 5. Personalização (Sugestões de Conversa)

1. *"Como o Conciliador de Despesas de Escritórios realiza suas tarefas?"*
2. *"Quais os dados necessarios para iniciar o Conciliador de Despesas de Escritórios?"*
3. *"Gerar um relatorio de analise do Conciliador de Despesas de Escritórios."*
