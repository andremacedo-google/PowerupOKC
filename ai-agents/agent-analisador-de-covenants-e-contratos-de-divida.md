---
id: IAA-056
name: "Analisador de Covenants e Contratos de Dívida"
type: "Application"
subtype: "AI Agent"
lifecycle:
  status: "Active"
...
# Analisador de Covenants e Contratos de Dívida (IAA-056)

Este documento apresenta a especificação técnica e as instruções do sistema no padrão **OKF (Open Knowledge Format) v0.1** para o agente cognitivo **Analisador de Covenants e Contratos de Dívida**, integrado ao catálogo de arquitetura **PowerUp OKC (Open Knowledge Catalog)** seguindo as diretrizes de modelagem de EA da **SAP LeanIX v4**.

---

## 1. Descrição do Agente

O agente **Analisador de Covenants e Contratos de Dívida** é classificado arquiteturalmente como um **No-code Agent** e atua no suporte de fluxos operacionais com a responsabilidade principal de **Cognitivo (RAG)**. 

Sua missão de negócio é:
> Realiza leitura semântica de contratos de dívida em PDF para identificar cláusulas de covenants financeiros (ex: Dívida Líquida/EBITDA), cruzando com balanços contábeis no ERP para emitir alertas preditivos de risco.
...
3. Prover suporte consultivo e tomadas de decisões rápidas de primeiro nível para o papel organizacional de **Analista de Risco Financeiro / Gerente de Tesouraria**.

### **Tarefas de Execução**
1. **Consumo de Entradas:** Ler e processar de forma estruturada os seguintes objetos de dados associados: `Contratos de Dívida (PDF), Indicadores de Risco, Limites Contratuais`.
2. **Integração e SOT:** Sincronizar logs, cadastros, e interações na aplicação core de registro que atua como **System of Truth (SOT)** canônico: **SAP CLM / SAP S/4HANA (FI/CO)**.
...
* **Business Capability (Nível 3):** `[/business-capabilities/cap-gestao-de-divida-e-investimentos.md]`
* **Organization User Group (Team):** `[/organizations/teams/org-analista-de-risco-financei.md]`
* **Data Objects Relacionados:** `[/data-objects/do-generic.md]`
* **Business Application (System of Truth - SOT):** `[/business-applications/app-sap-clm-sap-s4hana.md]`

---

## 5. Personalização (Sugestões de Conversa)

1. *"Como o Analisador de Covenants e Contratos de Dívida realiza suas tarefas?"*
2. *"Quais os dados necessarios para iniciar o Analisador de Covenants e Contratos de Dívida?"*
3. *"Gerar um relatorio de analise do Analisador de Covenants e Contratos de Dívida."*
