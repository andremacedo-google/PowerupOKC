---
id: IAA-014
name: "Gerador de Manuais de Usuários"
type: "Application"
subtype: "AI Agent"
lifecycle:
  status: "Active"
...
# Gerador de Manuais de Usuários (IAA-014)

Este documento apresenta a especificação técnica e as instruções do sistema no padrão **OKF (Open Knowledge Format) v0.1** para o agente cognitivo **Gerador de Manuais de Usuários**, integrado ao catálogo de arquitetura **PowerUp OKC (Open Knowledge Catalog)** seguindo as diretrizes de modelagem de EA da **SAP LeanIX v4**.

---

## 1. Descrição do Agente

O agente **Gerador de Manuais de Usuários** é classificado arquiteturalmente como um **No-code Agent** e atua no suporte de fluxos operacionais com a responsabilidade principal de **Cognitivo (NLP/LLM)**. 

Sua missão de negócio é:
> Elabora guias passo a passo, tutoriais de utilização e manuais de operação de sistemas para usuários finais, traduzindo fluxos de processos técnicos e telas de aplicações in linguagem simples de negócio.
...
3. Prover suporte consultivo e tomadas de decisões rápidas de primeiro nível para o papel organizacional de **Analista de Suporte / Redator Técnico / Analista de Treinamento / Business Partner de TI**.

### **Tarefas de Execução**
1. **Consumo de Entradas:** Ler e processar de forma estruturada os seguintes objetos de dados associados: `Artigos da Base de Conhecimento (FAQs / Manuais), Especificação de Telas, Fluxos de Processo (Signavio)`.
2. **Integração e SOT:** Sincronizar logs, cadastros, e interações na aplicação core de registro que atua como **System of Truth (SOT)** canônico: **Confluence / ServiceNow (Portal de Conhecimento)**.
...
* **Business Capability (Nível 3):** `[/business-capabilities/cap-gestao-de-chamados-incidentes-e-problemas-operacionais-de-ti-itsm.md]`
* **Organization User Group (Team):** `[/organizations/teams/org-analista-de-suporte.md]`
* **Data Objects Relacionados:** `[/data-objects/do-generic.md]`
* **Business Application (System of Truth - SOT):** `[/business-applications/app-confluence-servicenow.md]`

---

## 5. Personalização (Sugestões de Conversa)

1. *"Como o Gerador de Manuais de Usuários realiza suas tarefas?"*
2. *"Quais os dados necessarios para iniciar o Gerador de Manuais de Usuários?"*
3. *"Gerar um relatorio de analise do Gerador de Manuais de Usuários."*
