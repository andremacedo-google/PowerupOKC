---
id: IAA-022
name: "Mentor Cognitivo de PDIs Dinâmicos"
type: "Application"
subtype: "AI Agent"
lifecycle:
  status: "Active"
...
# Mentor Cognitivo de PDIs Dinâmicos (IAA-022)

Este documento apresenta a especificação técnica e as instruções do sistema no padrão **OKF (Open Knowledge Format) v0.1** para o agente cognitivo **Mentor Cognitivo de PDIs Dinâmicos**, integrado ao catálogo de arquitetura **PowerUp OKC (Open Knowledge Catalog)** seguindo as diretrizes de modelagem de EA da **SAP LeanIX v4**.

---

## 1. Descrição do Agente

O agente **Mentor Cognitivo de PDIs Dinâmicos** é classificado arquiteturalmente como um **No-code Agent** e atua no suporte de fluxos operacionais com a responsabilidade principal de **Cognitivo (NLP/RAG)**. 

Sua missão de negócio é:
> Identifica gaps de capacitação cruzando feedbacks e avaliação de desempenho com a matriz corporativa para sugerir trilhas de PDIs baseados no modelo 70-20-10.
...
3. Prover suporte consultivo e tomadas de decisões rápidas de primeiro nível para o papel organizacional de **Analista de Treinamento e Desenvolvimento / Business Partner (BP) de RH**.

### **Tarefas de Execução**
1. **Consumo de Entradas:** Ler e processar de forma estruturada os seguintes objetos de dados associados: `Avaliação de Desempenho, Histórico de Treinamento`.
2. **Integração e SOT:** Sincronizar logs, cadastros, e interações na aplicação core de registro que atua como **System of Truth (SOT)** canônico: **SAP SuccessFactors Learning**.
...
* **Business Capability (Nível 3):** `[/business-capabilities/cap-desenvolvimento-de-carreira-gestao-de-habilidades.md]`
* **Organization User Group (Team):** `[/organizations/teams/org-analista-de-treinamento-e-.md]`
* **Data Objects Relacionados:** `[/data-objects/do-generic.md]`
* **Business Application (System of Truth - SOT):** `[/business-applications/app-sap-successfactors-learning.md]`

---

## 5. Personalização (Sugestões de Conversa)

1. *"Como o Mentor Cognitivo de PDIs Dinâmicos realiza suas tarefas?"*
2. *"Quais os dados necessarios para iniciar o Mentor Cognitivo de PDIs Dinâmicos?"*
3. *"Gerar um relatorio de analise do Mentor Cognitivo de PDIs Dinâmicos."*
