---
id: IAA-044
name: "Analisador de Cláusulas e Riscos"
type: "Application"
subtype: "AI Agent"
lifecycle:
  status: "Active"
...
# Analisador de Cláusulas e Riscos (IAA-044)

Este documento apresenta a especificação técnica e as instruções do sistema no padrão **OKF (Open Knowledge Format) v0.1** para o agente cognitivo **Analisador de Cláusulas e Riscos**, integrado ao catálogo de arquitetura **PowerUp OKC (Open Knowledge Catalog)** seguindo as diretrizes de modelagem de EA da **SAP LeanIX v4**.

---

## 1. Descrição do Agente

O agente **Analisador de Cláusulas e Riscos** é classificado arquiteturalmente como um **No-code Agent** e atua no suporte de fluxos operacionais com a responsabilidade principal de **Cognitivo (RAG)**. 

Sua missão de negócio é:
> Analisa minutas de contratos complexos de terceiros contra o playbook interno, identificando 'Red Flags' em cláusulas críticas (como IPCA/IGP-M, take-or-pay, limites de responsabilidade).
...
3. Prover suporte consultivo e tomadas de decisões rápidas de primeiro nível para o papel organizacional de **Advogado Societário Sênior / Gerente Jurídico**.

### **Tarefas de Execução**
1. **Consumo de Entradas:** Ler e processar de forma estruturada os seguintes objetos de dados associados: `Minutas de Contratos (PDF), Políticas de Compliance`.
...
1. *"Como o Analisador de Cláusulas e Riscos realiza suas tarefas?"*
2. *"Quais os dados necessarios para iniciar o Analisador de Cláusulas e Riscos?"*
3. *"Gerar um relatorio de analise do Analisador de Cláusulas e Riscos."*
