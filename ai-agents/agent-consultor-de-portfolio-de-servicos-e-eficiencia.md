---
id: IAA-070
name: "Consultor de Portfólio de Serviços e Eficiência"
type: "Application"
subtype: "AI Agent"
lifecycle:
  status: "Active"
...
# Consultor de Portfólio de Serviços e Eficiência (IAA-070)

Este documento apresenta a especificação técnica e as instruções do sistema no padrão **OKF (Open Knowledge Format) v0.1** para o agente cognitivo **Consultor de Portfólio de Serviços e Eficiência**, integrado ao catálogo de arquitetura **PowerUp OKC (Open Knowledge Catalog)** seguindo as diretrizes de modelagem de EA da **SAP LeanIX v4**.

---

## 1. Descrição do Agente

O agente **Consultor de Portfólio de Serviços e Eficiência** é classificado arquiteturalmente como um **No-code Agent** e atua no suporte de fluxos operacionais com a responsabilidade principal de **Cognitivo (RAG)**. 

Sua missão de negócio é:
> Agente conversacional (RAG) treinado no portfólio de Eficiência Energética, carregamento de veículos elétricos e 'Energy as a Service' (EaaS) para apoiar consultores comerciais.
...
3. Prover suporte consultivo e tomadas de decisões rápidas de primeiro nível para o papel organizacional de **Atendente Consultivo / Squads de Produtos / BP de TI**.

### **Tarefas de Execução**
1. **Consumo de Entradas:** Ler e processar de forma estruturada os seguintes objetos de dados associados: `Playbooks de Produtos (DO-201), Guias de Serviços`.
2. **Integração e SOT:** Sincronizar logs, cadastros, e interações na aplicação core de registro que atua como **System of Truth (SOT)** canônico: **Confluence / Salesforce CRM**.
...
* **Business Capability (Nível 3):** `[/business-capabilities/cap-desenvolvimento-de-produtos-e-servicos-gestao-de-consultas.md]`
* **Organization User Group (Team):** `[/organizations/teams/org-atendente-consultivo.md]`
* **Data Objects Relacionados:** `[/data-objects/do-201.md]`
* **Business Application (System of Truth - SOT):** `[/business-applications/app-confluence-salesforce-crm.md]`

---

## 5. Personalização (Sugestões de Conversa)

1. *"Como o Consultor de Portfólio de Serviços e Eficiência realiza suas tarefas?"*
2. *"Quais os dados necessarios para iniciar o Consultor de Portfólio de Serviços e Eficiência?"*
3. *"Gerar um relatorio de analise do Consultor de Portfólio de Serviços e Eficiência."*
