---
id: IAA-066
name: "Gerador de Conteúdo e Campanhas Multicanal"
type: "Application"
subtype: "AI Agent"
lifecycle:
  status: "Active"
...
# Gerador de Conteúdo e Campanhas Multicanal (IAA-066)

Este documento apresenta a especificação técnica e as instruções do sistema no padrão **OKF (Open Knowledge Format) v0.1** para o agente cognitivo **Gerador de Conteúdo e Campanhas Multicanal**, integrado ao catálogo de arquitetura **PowerUp OKC (Open Knowledge Catalog)** seguindo as diretrizes de modelagem de EA da **SAP LeanIX v4**.

---

## 1. Descrição do Agente

O agente **Gerador de Conteúdo e Campanhas Multicanal** é classificado arquiteturalmente como um **No-code Agent** e atua no suporte de fluxos operacionais com a responsabilidade principal de **Cognitivo (GenAI)**. 

Sua missão de negócio é:
> Auxilia na redação de textos promocionais, e-mails de marketing e pushes personalizados para o aplicativo de fidelidade, adaptando o tom de voz corporativo com base em guias de marca.
...
3. Prover suporte consultivo e tomadas de decisões rápidas de primeiro nível para o papel organizacional de **Analista de Marketing Digital / Copywriter / Gestor de Campanhas**.

### **Tarefas de Execução**
1. **Consumo de Entradas:** Ler e processar de forma estruturada os seguintes objetos de dados associados: `Peça Publicitária, Diretrizes de Marca (Não Estruturado)`.
2. **Integração e SOT:** Sincronizar logs, cadastros, e interações na aplicação core de registro que atua como **System of Truth (SOT)** canônico: **Salesforce CRM / SharePoint**.
...
* **Business Capability (Nível 3):** `[/business-capabilities/cap-gestao-de-campanhas-de-marketing-colaboracao.md]`
* **Organization User Group (Team):** `[/organizations/teams/org-analista-de-marketing-digi.md]`
* **Data Objects Relacionados:** `[/data-objects/do-generic.md]`
* **Business Application (System of Truth - SOT):** `[/business-applications/app-salesforce-crm-sharepoint.md]`

---

## 5. Personalização (Sugestões de Conversa)

1. *"Como o Gerador de Conteúdo e Campanhas Multicanal realiza suas tarefas?"*
2. *"Quais os dados necessarios para iniciar o Gerador de Conteúdo e Campanhas Multicanal?"*
3. *"Gerar um relatorio de analise do Gerador de Conteúdo e Campanhas Multicanal."*
