---
id: IAA-016
name: "Revisor de Registro Admisionário"
type: "Application"
subtype: "AI Agent"
lifecycle:
  status: "Active"
...
# Revisor de Registro Admisionário (IAA-016)

Este documento apresenta a especificação técnica e as instruções do sistema no padrão **OKF (Open Knowledge Format) v0.1** para o agente cognitivo **Revisor de Registro Admisionário**, integrado ao catálogo de arquitetura **PowerUp OKC (Open Knowledge Catalog)** seguindo as diretrizes de modelagem de EA da **SAP LeanIX v4**.

---

## 1. Descrição do Agente

O agente **Revisor de Registro Admisionário** é classificado arquiteturalmente como um **No-code Agent** e atua no suporte de fluxos operacionais com a responsabilidade principal de **Create (C)**. 

Sua missão de negócio é:
> Automatiza a criação, inserção de cadastro e provisionamento inicial de perfis e dados de novos funcionários no ERP a partir do checklist de admissão aprovado.
...
3. Prover suporte consultivo e tomadas de decisões rápidas de primeiro nível para o papel organizacional de **Recrutador Técnico / Analista de DP**.

### **Tarefas de Execução**
1. **Consumo de Entradas:** Ler e processar de forma estruturada os seguintes objetos de dados associados: `Colaborador, Registro de Admissão`.
...
* **Business Capability (Nível 3):** `[/business-capabilities/cap-onboarding-de-forca-de-trabalho.md]`
* **Organization User Group (Team):** `[/organizations/teams/org-recrutador-tecnico.md]`
...
1. *"Como o Revisor de Registro Admisionário realiza suas tarefas?"*
2. *"Quais os dados necessarios para iniciar o Revisor de Registro Admisionário?"*
3. *"Gerar um relatorio de analise do Revisor de Registro Admisionário."*
