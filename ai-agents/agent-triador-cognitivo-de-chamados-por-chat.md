---
id: IAA-010
name: "Triador Cognitivo de Chamados por Chat"
type: "Application"
subtype: "AI Agent"
lifecycle:
  status: "Active"
...
# Triador Cognitivo de Chamados por Chat (IAA-010)

Este documento apresenta a especificação técnica e as instruções do sistema no padrão **OKF (Open Knowledge Format) v0.1** para o agente cognitivo **Triador Cognitivo de Chamados por Chat**, integrado ao catálogo de arquitetura **PowerUp OKC (Open Knowledge Catalog)** seguindo as diretrizes de modelagem de EA da **SAP LeanIX v4**.

---

## 1. Descrição do Agente

O agente **Triador Cognitivo de Chamados por Chat** é classificado arquiteturalmente como um **No-code Agent** e atua no suporte de fluxos operacionais com a responsabilidade principal de **Cognitivo (NLP)**. 

Sua missão de negócio é:
> Interage com os colaboradores via canais corporativos por chatbot, interpretando a intenção e sentimento de reclamações lógicas e transferindo o histórico para o analista N2 se necessário.
...
3. Prover suporte consultivo e tomadas de decisões rápidas de primeiro nível para o papel organizacional de **Operador de Service Desk / Analista de Suporte N1**.

### **Tarefas de Execução**
1. **Consumo de Entradas:** Ler e processar de forma estruturada os seguintes objetos de dados associados: `Conversa de Atendimento, FAQ de TI, Perfil do Usuário`.
2. **Integração e SOT:** Sincronizar logs, cadastros, e interações na aplicação core de registro que atua como **System of Truth (SOT)** canônico: **ServiceNow ITSM / Microsoft Teams**.
...
* **Organization User Group (Team):** `[/organizations/teams/org-operador-de-service-desk.md]`
* **Data Objects Relacionados:** `[/data-objects/do-generic.md]`
* **Business Application (System of Truth - SOT):** `[/business-applications/app-servicenow-itsm-microsoft-teams.md]`

---

## 5. Personalização (Sugestões de Conversa)

1. *"Como o Triador Cognitivo de Chamados por Chat realiza suas tarefas?"*
2. *"Quais os dados necessarios para iniciar o Triador Cognitivo de Chamados por Chat?"*
3. *"Gerar um relatorio de analise do Triador Cognitivo de Chamados por Chat."*
