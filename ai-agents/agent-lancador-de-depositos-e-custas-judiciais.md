---
id: IAA-040
name: "Lançador de Depósitos e Custas Judiciais"
type: "Application"
subtype: "AI Agent"
lifecycle:
  status: "Active"
...
# Lançador de Depósitos e Custas Judiciais (IAA-040)

Este documento apresenta a especificação técnica e as instruções do sistema no padrão **OKF (Open Knowledge Format) v0.1** para o agente cognitivo **Lançador de Depósitos e Custas Judiciais**, integrado ao catálogo de arquitetura **PowerUp OKC (Open Knowledge Catalog)** seguindo as diretrizes de modelagem de EA da **SAP LeanIX v4**.

---

## 1. Descrição do Agente

O agente **Lançador de Depósitos e Custas Judiciais** é classificado arquiteturalmente como um **Data Agent** e atua no suporte de fluxos operacionais com a responsabilidade principal de **Create (C)**. 

Sua missão de negócio é:
> Gera requisições de pagamento de custas, depósitos recursais e garantias judiciais diretamente no contas a pagar do ERP após identificação de andamento crítico.
...
3. Prover suporte consultivo e tomadas de decisões rápidas de primeiro nível para o papel organizacional de **Analista de Processos Judiciais / Analista Financeiro**.

### **Tarefas de Execução**
1. **Consumo de Entradas:** Ler e processar de forma estruturada os seguintes objetos de dados associados: `Pagamento, Lançamento Contábil`.
...
* **Business Capability (Nível 3):** `[/business-capabilities/cap-gestao-de-contas-a-pagar-e-receber.md]`
* **Organization User Group (Team):** `[/organizations/teams/org-analista-de-processos-judi.md]`
...
1. *"Como o Lançador de Depósitos e Custas Judiciais realiza suas tarefas?"*
2. *"Quais os dados necessarios para iniciar o Lançador de Depósitos e Custas Judiciais?"*
3. *"Gerar um relatorio de analise do Lançador de Depósitos e Custas Judiciais."*
