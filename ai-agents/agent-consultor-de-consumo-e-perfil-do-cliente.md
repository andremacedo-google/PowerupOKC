---
id: IAA-061
name: "Consultor de Consumo e Perfil do Cliente"
type: "Application"
subtype: "AI Agent"
lifecycle:
  status: "Active"
...
# Consultor de Consumo e Perfil do Cliente (IAA-061)

Este documento apresenta a especificação técnica e as instruções do sistema no padrão **OKF (Open Knowledge Format) v0.1** para o agente cognitivo **Consultor de Consumo e Perfil do Cliente**, integrado ao catálogo de arquitetura **PowerUp OKC (Open Knowledge Catalog)** seguindo as diretrizes de modelagem de EA da **SAP LeanIX v4**.

---

## 1. Descrição do Agente

O agente **Consultor de Consumo e Perfil do Cliente** é classificado arquiteturalmente como um **Data Agent** e atua no suporte de fluxos operacionais com a responsabilidade principal de **Read (R)**. 

Sua missão de negócio é:
> Consulta de forma ágil o histórico de consumo acumulado, perfil tarifário e as informações básicas da UC direto no banco do CIS para subsidiar tomadas de decisões de vendas e prospecções comerciais.
...
3. Prover suporte consultivo e tomadas de decisões rápidas de primeiro nível para o papel organizacional de **Analista de Inteligência de Mercado / Analista Comercial**.

### **Tarefas de Execução**
1. **Consumo de Entradas:** Ler e processar de forma estruturada os seguintes objetos de dados associados: `Cliente (Parceiro de Negócio), Unidade Consumidora (UC), Fatura (Conta de Energia)`.
2. **Integração e SOT:** Sincronizar logs, cadastros, e interações na aplicação core de registro que atua como **System of Truth (SOT)** canônico: **SAP IS-U (CIS)**.
...
* **Business Capability (Nível 3):** `[/business-capabilities/cap-analise-de-marketing-gestao-de-clientes.md]`
* **Organization User Group (Team):** `[/organizations/teams/org-analista-de-inteligencia-d.md]`
...
1. *"Como o Consultor de Consumo e Perfil do Cliente realiza suas tarefas?"*
2. *"Quais os dados necessarios para iniciar o Consultor de Consumo e Perfil do Cliente?"*
3. *"Gerar um relatorio de analise do Consultor de Consumo e Perfil do Cliente."*
