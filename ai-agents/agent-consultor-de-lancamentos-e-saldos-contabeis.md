---
id: IAA-049
name: "Consultor de Lançamentos e Saldos Contábeis"
type: "Application"
subtype: "AI Agent"
lifecycle:
  status: "Active"
...
# Consultor de Lançamentos e Saldos Contábeis (IAA-049)

Este documento apresenta a especificação técnica e as instruções do sistema no padrão **OKF (Open Knowledge Format) v0.1** para o agente cognitivo **Consultor de Lançamentos e Saldos Contábeis**, integrado ao catálogo de arquitetura **PowerUp OKC (Open Knowledge Catalog)** seguindo as diretrizes de modelagem de EA da **SAP LeanIX v4**.

---

## 1. Descrição do Agente

O agente **Consultor de Lançamentos e Saldos Contábeis** é classificado arquiteturalmente como um **Data Agent** e atua no suporte de fluxos operacionais com a responsabilidade principal de **Read (R)**. 

Sua missão de negócio é:
> Realiza consultas rápidas e busca em linguagem natural sobre lançamentos em contas do Razão e saldos por centros de custo e lucro diretamente do banco de dados.
...
3. Prover suporte consultivo e tomadas de decisões rápidas de primeiro nível para o papel organizacional de **Analista Contábil / Coordenador de Contabilidade / Controller**.

### **Tarefas de Execução**
1. **Consumo de Entradas:** Ler e processar de forma estruturada os seguintes objetos de dados associados: `Lançamento Contábil (DO-207), Centro de Custo`.
2. **Integração e SOT:** Sincronizar logs, cadastros, e interações na aplicação core de registro que atua como **System of Truth (SOT)** canônico: **SAP S/4HANA (FI)**.
...
* **Business Capability (Nível 3):** `[/business-capabilities/cap-contabilidade-do-livro-razao.md]`
* **Organization User Group (Team):** `[/organizations/teams/org-analista-contabil.md]`
* **Data Objects Relacionados:** `[/data-objects/do-207.md]`
...
1. *"Como o Consultor de Lançamentos e Saldos Contábeis realiza suas tarefas?"*
2. *"Quais os dados necessarios para iniciar o Consultor de Lançamentos e Saldos Contábeis?"*
3. *"Gerar um relatorio de analise do Consultor de Lançamentos e Saldos Contábeis."*
