---
id: IAA-017
name: "Atualizador de Certificações e NRs"
type: "Application"
subtype: "AI Agent"
lifecycle:
  status: "Active"
...
# Atualizador de Certificações e NRs (IAA-017)

Este documento apresenta a especificação técnica e as instruções do sistema no padrão **OKF (Open Knowledge Format) v0.1** para o agente cognitivo **Atualizador de Certificações e NRs**, integrado ao catálogo de arquitetura **PowerUp OKC (Open Knowledge Catalog)** seguindo as diretrizes de modelagem de EA da **SAP LeanIX v4**.

---

## 1. Descrição do Agente

O agente **Atualizador de Certificações e NRs** é classificado arquiteturalmente como um **Data Agent** e atua no suporte de fluxos operacionais com a responsabilidade principal de **Update (U)**. 

Sua missão de negócio é:
> Sincroniza e insere de forma transacional as atualizações e revalidações de certificações técnicas regulatórias obrigatórias (NR-10, NR-35, etc.) diretamente no LMS.
...
3. Prover suporte consultivo e tomadas de decisões rápidas de primeiro nível para o papel organizacional de **Analista de Treinamento e Desenvolvimento / Supervisor de Campo**.

### **Tarefas de Execução**
1. **Consumo de Entradas:** Ler e processar de forma estruturada os seguintes objetos de dados associados: `Histórico de Treinamento, Certificado NR`.
...
* **Business Capability (Nível 3):** `[/business-capabilities/cap-gestao-de-habilidades-e-competencias.md]`
...
1. *"Como o Atualizador de Certificações e NRs realiza suas tarefas?"*
2. *"Quais os dados necessarios para iniciar o Atualizador de Certificações e NRs?"*
3. *"Gerar um relatorio de analise do Atualizador de Certificações e NRs."*
