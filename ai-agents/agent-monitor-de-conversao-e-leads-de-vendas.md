---
id: IAA-063
name: "Monitor de Conversão e Leads de Vendas"
type: "Application"
subtype: "AI Agent"
lifecycle:
  status: "Active"
...
# Monitor de Conversão e Leads de Vendas (IAA-063)

Este documento apresenta a especificação técnica e as instruções do sistema no padrão **OKF (Open Knowledge Format) v0.1** para o agente cognitivo **Monitor de Conversão e Leads de Vendas**, integrado ao catálogo de arquitetura **PowerUp OKC (Open Knowledge Catalog)** seguindo as diretrizes de modelagem de EA da **SAP LeanIX v4**.

---

## 1. Descrição do Agente

O agente **Monitor de Conversão e Leads de Vendas** é classificado arquiteturalmente como um **Data Agent** e atua no suporte de fluxos operacionais com a responsabilidade principal de **Read (R)**. 

Sua missão de negócio é:
> Analisa a taxa de avanço e conversão de oportunidades no funil de vendas, calculando tempos de permanência em cada estágio para mitigar riscos de desistência.
...
3. Prover suporte consultivo e tomadas de decisões rápidas de primeiro nível para o papel organizacional de **Gerente de Vendas / Analista de CRM / Analista Comercial**.

### **Tarefas de Execução**
1. **Consumo de Entradas:** Ler e processar de forma estruturada os seguintes objetos de dados associados: `Lead, Oportunidade, Histórico de Contato`.
...
* **Business Capability (Nível 3):** `[/business-capabilities/cap-gestao-de-pipeline-analise-de-vendas.md]`
* **Organization User Group (Team):** `[/organizations/teams/org-gerente-de-vendas.md]`
...
1. *"Como o Monitor de Conversão e Leads de Vendas realiza suas tarefas?"*
2. *"Quais os dados necessarios para iniciar o Monitor de Conversão e Leads de Vendas?"*
3. *"Gerar um relatorio de analise do Monitor de Conversão e Leads de Vendas."*
