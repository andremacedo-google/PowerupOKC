---
id: IAA-054
name: "Sincronizador de Ativos Imobilizados"
type: "Application"
subtype: "AI Agent"
lifecycle:
  status: "Active"
...
# Sincronizador de Ativos Imobilizados (IAA-054)

Este documento apresenta a especificação técnica e as instruções do sistema no padrão **OKF (Open Knowledge Format) v0.1** para o agente cognitivo **Sincronizador de Ativos Imobilizados**, integrado ao catálogo de arquitetura **PowerUp OKC (Open Knowledge Catalog)** seguindo as diretrizes de modelagem de EA da **SAP LeanIX v4**.

---

## 1. Descrição do Agente

O agente **Sincronizador de Ativos Imobilizados** é classificado arquiteturalmente como um **Data Agent** e atua no suporte de fluxos operacionais com a responsabilidade principal de **Create / Update (C/U)**. 

Sua missão de negócio é:
> Registra e atualiza automaticamente o cadastro de ativos imobilizados no módulo contábil do ERP após formalização da sua unitização física e liberação de entrada em serviço.
...
3. Prover suporte consultivo e tomadas de decisões rápidas de primeiro nível para o papel organizacional de **Analista de Ativos / Gerente de Contabilidade de Ativos**.

### **Tarefas de Execução**
1. **Consumo de Entradas:** Ler e processar de forma estruturada os seguintes objetos de dados associados: `Ativo Fixo (Contábil), Ativo Regulatório`.
2. **Integração e SOT:** Sincronizar logs, cadastros, e interações na aplicação core de registro que atua como **System of Truth (SOT)** canônico: **SAP S/4HANA (FI-AA)**.
...
* **Business Capability (Nível 3):** `[/business-capabilities/cap-contabilidade-de-ativos.md]`
* **Organization User Group (Team):** `[/organizations/teams/org-analista-de-ativos.md]`
...
1. *"Como o Sincronizador de Ativos Imobilizados realiza suas tarefas?"*
2. *"Quais os dados necessarios para iniciar o Sincronizador de Ativos Imobilizados?"*
3. *"Gerar um relatorio de analise do Sincronizador de Ativos Imobilizados."*
