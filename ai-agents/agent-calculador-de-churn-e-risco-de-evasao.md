---
id: IAA-064
name: "Calculador de Churn e Risco de Evasão"
type: "Application"
subtype: "AI Agent"
lifecycle:
  status: "Active"
...
# Calculador de Churn e Risco de Evasão (IAA-064)

Este documento apresenta a especificação técnica e as instruções do sistema no padrão **OKF (Open Knowledge Format) v0.1** para o agente cognitivo **Calculador de Churn e Risco de Evasão**, integrado ao catálogo de arquitetura **PowerUp OKC (Open Knowledge Catalog)** seguindo as diretrizes de modelagem de EA da **SAP LeanIX v4**.

---

## 1. Descrição do Agente

O agente **Calculador de Churn e Risco de Evasão** é classificado arquiteturalmente como um **Data Agent** e atua no suporte de fluxos operacionais com a responsabilidade principal de **Read / Update (R/U)**. 

Sua missão de negócio é:
> Rastreia indicadorse comerciais e faturamentos em aberto, gravando pontuações de risco de cancelamento diretamente na ficha cadastral do cliente no CRM.
...
3. Prover suporte consultivo e tomadas de decisões rápidas de primeiro nível para o papel organizacional de **Gestor de CRM / Especialista de Growth / Analista de Retenção**.

### **Tarefas de Execução**
1. **Consumo de Entradas:** Ler e processar de forma estruturada os seguintes objetos de dados associados: `Cliente, Fatura (Conta de Energia), Histórico de Contato`.
...
* **Business Capability (Nível 3):** `[/business-capabilities/cap-analise-de-marketing-gestao-de-inadimplencia.md]`
* **Organization User Group (Team):** `[/organizations/teams/org-gestor-de-crm.md]`
...
1. *"Como o Calculador de Churn e Risco de Evasão realiza suas tarefas?"*
2. *"Quais os dados necessarios para iniciar o Calculador de Churn e Risco de Evasão?"*
3. *"Gerar um relatorio de analise do Calculador de Churn e Risco de Evasão."*
