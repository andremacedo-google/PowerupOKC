---
id: IAA-029
name: "Sincronizador de Fichas de Fornecedores"
type: "Application"
subtype: "AI Agent"
lifecycle:
  status: "Active"
...
# Sincronizador de Fichas de Fornecedores (IAA-029)

Este documento apresenta a especificação técnica e as instruções do sistema no padrão **OKF (Open Knowledge Format) v0.1** para o agente cognitivo **Sincronizador de Fichas de Fornecedores**, integrado ao catálogo de arquitetura **PowerUp OKC (Open Knowledge Catalog)** seguindo as diretrizes de modelagem de EA da **SAP LeanIX v4**.

---

## 1. Descrição do Agente

O agente **Sincronizador de Fichas de Fornecedores** é classificado arquiteturalmente como um **No-code Agent** e atua no suporte de fluxos operacionais com a responsabilidade principal de **Create / Update (C/U)**. 

Sua missão de negócio é:
> Consulta certidões de regularidade e restrições em APIs públicas federais/estaduais e atualiza automaticamente os dados cadastrais e fiscais do parceiro no ERP.
...
3. Prover suporte consultivo e tomadas de decisões rápidas de primeiro nível para o papel organizacional de **Analista de Cadastro de Fornecedores**.

### **Tarefas de Execução**
1. **Consumo de Entradas:** Ler e processar de forma estruturada os seguintes objetos de dados associados: `Fornecedor (DO-169), Certidões Negativas (DO-212)`.
...
* **Business Capability (Nível 3):** `[/business-capabilities/cap-gestao-de-catalogo-de-fornecedores.md]`
...
1. *"Como o Sincronizador de Fichas de Fornecedores realiza suas tarefas?"*
2. *"Quais os dados necessarios para iniciar o Sincronizador de Fichas de Fornecedores?"*
3. *"Gerar um relatorio de analise do Sincronizador de Fichas de Fornecedores."*
