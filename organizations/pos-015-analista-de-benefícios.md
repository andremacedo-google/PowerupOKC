...
# Analista de Benefícios (ID: POS-015)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Analista de Benefícios** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Analista de Benefícios** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Administrar o portfólio de benefícios, planos de saúde, previdência privada corporativa complementar e coordenar fluxos de reembolso de funcionários.
...
*   **Sistemas e Aplicações Utilizados (How):** SAP SuccessFactors EC
