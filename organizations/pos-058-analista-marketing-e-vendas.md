---
id: "POS-058"
name: "Analista Marketing e Vendas"
type: "Position"
...
# Analista Marketing e Vendas (ID: POS-058)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Analista Marketing e Vendas** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Analista Marketing e Vendas** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Estruturar propostas comerciais e simulações econômicas de viabilidade de economia para migração de consumidores industriais ao ACL.
...
*   **Sistemas e Aplicações Utilizados (How):** Salesforce CRM
