---
id: "POS-040"
name: "Operador de Subestação Sênior"
type: "Position"
...
# Operador de Subestação Sênior (ID: POS-040)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Operador de Subestação Sênior** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Operador de Subestação Sênior** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Executar remotamente manobras de chaves seccionadoras e disjuntores de alta tensão de subestações sob coordenação direta do ONS.
...
*   **Organização de Pertencimento (Parent Team/BU):** [/organizations/teams/team-centro-operacao-transmissao.md](Centro de Operações da Transmissão (COT))
*   **Sistemas e Aplicações Utilizados (How):** SCADA EMS
