---
id: "POS-056"
name: "Analista de Inteligência de Mercado"
type: "Position"
...
# Analista de Inteligência de Mercado (ID: POS-056)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Analista de Inteligência de Mercado** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Analista de Inteligência de Mercado** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Analisar dados meteorológicos, previsões de vazão hidráulica de bacias e simular a formação estocástica de preços do PLD horário.
...
*   **Sistemas e Aplicações Utilizados (How):** Price Prediction Tools, Excel
