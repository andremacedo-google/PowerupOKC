---
id: "POS-035"
name: "Faturista de Energia Bilateral"
type: "Position"
...
# Faturista de Energia Bilateral (ID: POS-035)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Faturista de Energia Bilateral** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Faturista de Energia Bilateral** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Emitir faturas e notas fiscais de venda de energia do portfólio livre (PPAs), controlar prazos de cobrança e saldos de recebíveis.
...
*   **Organização de Pertencimento (Parent Team/BU):** [/organizations/teams/team-back-office-energia.md](Back-Office de Energia)
*   **Sistemas e Aplicações Utilizados (How):** SAP S/4HANA (FI)
