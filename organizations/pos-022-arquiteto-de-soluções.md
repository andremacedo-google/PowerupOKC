...
# Arquiteto de Soluções (ID: POS-022)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Arquiteto de Soluções** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.
...
*   Mapear a arquitetura corporativa unificada, desenhar workflows seguros de integração sistêmica e governar os Fact Sheets de aplicações.
...
*   **Sistemas e Aplicações Utilizados (How):** LeanIX, ServiceNow
