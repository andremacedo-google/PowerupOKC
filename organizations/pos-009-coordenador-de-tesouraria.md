---
id: "POS-009"
name: "Coordenador de Tesouraria"
type: "Position"
...
# Coordenador de Tesouraria (ID: POS-009)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Coordenador de Tesouraria** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Coordenador de Tesouraria** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Gerenciar a liquidez diária, projetar fluxo de caixa corporativo, captar recursos financeiros e gerenciar contratos de hedge contra riscos de PLD.
...
*   **Organização de Pertencimento (Parent Team/BU):** [/organizations/teams/team-tesouraria-caixa.md](Tesouraria e Caixa)
*   **Sistemas e Aplicações Utilizados (How):** SAP S/4HANA (TRM), Cash Portals
