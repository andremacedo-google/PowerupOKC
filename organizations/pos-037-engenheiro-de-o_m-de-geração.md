---
id: "POS-037"
name: "Engenheiro de O&M de Geração"
type: "Position"
...
# Engenheiro de O&M de Geração (ID: POS-037)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Engenheiro de O&M de Geração** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Engenheiro de O&M de Geração** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Garantir a conformidade dos parâmetros operativos das máquinas, coordenar ensaios de capacidade e interface técnica com o ONS.
...
*   **Sistemas e Aplicações Utilizados (How):** Hitachi GMS, SAGER
