---
id: "POS-044"
name: "Gerente de Faturamento Comercial"
type: "Position"
...
# Gerente de Faturamento Comercial (ID: POS-044)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Gerente de Faturamento Comercial** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Gerente de Faturamento Comercial** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Coordenar o ciclo Meter-to-Cash, aprovar e auditar corridas mensais em lote de faturamento, tarifas e arrecadação da base de consumidores.
...
*   **Sistemas e Aplicações Utilizados (How):** SAP IS-U / CCS
