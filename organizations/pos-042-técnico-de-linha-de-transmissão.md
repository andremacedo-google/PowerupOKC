---
id: "POS-042"
name: "Técnico de Linha de Transmissão"
type: "Position"
...
# Técnico de Linha de Transmissão (ID: POS-042)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Técnico de Linha de Transmissão** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Técnico de Linha de Transmissão** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Realizar podas, medições de aterramento, inspeções termográficas com drones em vãos de linhas de alta tensão.
...
*   **Sistemas e Aplicações Utilizados (How):** SAP PM, WFM
