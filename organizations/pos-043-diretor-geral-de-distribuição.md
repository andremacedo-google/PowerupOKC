---
id: "POS-043"
name: "Diretor Geral de Distribuição"
type: "Position"
...
# Diretor Geral de Distribuição (ID: POS-043)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Diretor Geral de Distribuição** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Diretor Geral de Distribuição** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Liderança executiva do negócio de distribuição de energia, garantindo metas regulatórias de continuidade DEC/FEC e mitigação de perdas.
...
*   **Organização de Pertencimento (Parent Team/BU):** [/organizations/legal-entities/dis-distribuicao-energia.md](Distribuição Energia S.A.)
*   **Sistemas e Aplicações Utilizados (How):** ADMS, CIS, SAP S/4HANA
