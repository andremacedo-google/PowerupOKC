---
id: "POS-033"
name: "Coordenador de Back-Office"
type: "Position"
...
# Coordenador de Back-Office (ID: POS-033)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Coordenador de Back-Office** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Coordenador de Back-Office** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Coordenar o fechamento mensal, auditoria de balanços energéticos físicos, e o processo de liquidação de posições no mercado de curto prazo.
...
*   **Sistemas e Aplicações Utilizados (How):** CliqCCEE, SCL CCEE
