---
id: "POS-048"
name: "Atendente Consultivo de Clientes"
type: "Position"
...
# Atendente Consultivo de Clientes (ID: POS-048)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Atendente Consultivo de Clientes** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Atendente Consultivo de Clientes** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Resolver casos complexos de faturamento, reclamações, solicitações comerciais de novas ligações no primeiro contato.
