---
id: "POS-041"
name: "Engenheiro de Proteção e Controle"
type: "Position"
...
# Engenheiro de Proteção e Controle (ID: POS-041)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Engenheiro de Proteção e Controle** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Engenheiro de Proteção e Controle** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Parametrizar relés de proteção de alta tensão, programar planos sistemáticos de ensaios elétricos e isolamento e auditar ocorrências.
...
*   **Organização de Pertencimento (Parent Team/BU):** [/organizations/teams/team-equipe-manutencao-ativos.md](Equipes de Manutenção de Ativos)
*   **Sistemas e Aplicações Utilizados (How):** SAP PM, Relays Software
