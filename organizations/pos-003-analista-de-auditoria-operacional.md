---
id: "POS-003"
name: "Analista de Auditoria Operacional"
type: "Position"
...
# Analista de Auditoria Operacional (ID: POS-003)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Analista de Auditoria Operacional** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Analista de Auditoria Operacional** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Executar testes de auditoria em processos operativos (como faturamento e unitização), identificar fraquezas de controles internos e monitorar planos de ação.
...
*   **Organização de Pertencimento (Parent Team/BU):** [/organizations/teams/team-auditoria.md](Auditoria Interna)
*   **Sistemas e Aplicações Utilizados (How):** SAP S/4HANA, GRC
