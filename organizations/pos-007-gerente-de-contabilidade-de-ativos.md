---
id: "POS-007"
name: "Gerente de Contabilidade de Ativos"
type: "Position"
...
# Gerente de Contabilidade de Ativos (ID: POS-007)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Gerente de Contabilidade de Ativos** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Gerente de Contabilidade de Ativos** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Garantir a conformidade fiscal-societária do imobilizado em curso ( AuC / Elementos PEP) e coordenar processos de unitização física e contábil.
...
*   **Sistemas e Aplicações Utilizados (How):** SAP S/4HANA (FI-AA/PS)
