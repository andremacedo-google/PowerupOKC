---
id: "POS-008"
name: "Analista de Ativos Regulatórios"
type: "Position"
...
# Analista de Ativos Regulatórios (ID: POS-008)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Analista de Ativos Regulatórios** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Analista de Ativos Regulatórios** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Mapear ativos patrimoniais conforme o Manual de Controle Patrimonial do Setor Elétrico (MCPSE) da ANEEL, alimentando a Base de Remuneração Regulatória (BRR).
...
*   **Organização de Pertencimento (Parent Team/BU):** [/organizations/teams/team-controladoria-contabilidade.md](Controladoria e Contabilidade)
*   **Sistemas e Aplicações Utilizados (How):** SAP FI-AA, MCPSE Add-on, Excel
