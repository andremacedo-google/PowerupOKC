---
id: "POS-031"
name: "Comprador de CAPEX de Engenharia"
type: "Position"
...
# Comprador de CAPEX de Engenharia (ID: POS-031)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Comprador de CAPEX de Engenharia** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Comprador de CAPEX de Engenharia** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Conduzir processos de RFP/RFI de compras de materiais pesados e subestações, equalizar propostas financeiras de fornecedores de EPC.
...
*   **Organização de Pertencimento (Parent Team/BU):** [/organizations/teams/team-compras-estrategicas.md](Compras Estratégicas)
*   **Sistemas e Aplicações Utilizados (How):** SAP MM, Coupa, SAP PS
