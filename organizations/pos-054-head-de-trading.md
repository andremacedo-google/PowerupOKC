...
# Head de Trading (ID: POS-054)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Head de Trading** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Head de Trading** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Aprovar estratégias comerciais e de portfólio físico e financeiro da mesa de trading de curto/médio prazo e posições de hedge da comercializadora.
...
*   **Sistemas e Aplicações Utilizados (How):** ETRM (Thunders), BBCE
