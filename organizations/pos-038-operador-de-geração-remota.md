---
id: "POS-038"
name: "Operador de Geração Remota"
type: "Position"
...
# Operador de Geração Remota (ID: POS-038)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Operador de Geração Remota** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Operador de Geração Remota** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Executar comandos lógicos e físicos de abertura/fechamento e despacho elétrico de turbinas remotamente conforme metas de geração do ONS.
...
*   **Organização de Pertencimento (Parent Team/BU):** [/organizations/teams/team-centro-operacao-geracao.md](Centro de Operações da Geração (COG))
*   **Sistemas e Aplicações Utilizados (How):** SCADA GMS, SAGER
