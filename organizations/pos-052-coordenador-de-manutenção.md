---
id: "POS-052"
name: "Coordenador de Manutenção"
type: "Position"
...
# Coordenador de Manutenção (ID: POS-052)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Coordenador de Manutenção** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Coordenador de Manutenção** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Coordenar e planejar as equipes de campo técnicas de emergência (restabelecimento de energia) e preventivas sistemáticas (poda, troca de postes).
...
*   **Sistemas e Aplicações Utilizados (How):** WFM, SAP PM
