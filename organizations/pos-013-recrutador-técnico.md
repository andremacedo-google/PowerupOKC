...
# Recrutador Técnico (ID: POS-013)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Recrutador Técnico** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Recrutador Técnico** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Conduzir triagens de currículos, agendar entrevistas técnicas para posições críticas de engenharia de campo e coordenar o onboarding digital.
...
*   **Sistemas e Aplicações Utilizados (How):** SAP SuccessFactors Recruiting
