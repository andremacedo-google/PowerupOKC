...
# Gerente de Comunicação (ID: POS-004)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Gerente de Comunicação** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Gerente de Comunicação** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Gerenciar a assessoria de imprensa do grupo, a imagem pública institucional, relações com stakeholders externos e o portal corporativo de endomarketing.
...
*   **Organização de Pertencimento (Parent Team/BU):** [/organizations/teams/team-comunicacao-corporativa.md](Comunicação Corporativa)
*   **Sistemas e Aplicações Utilizados (How):** Portal de Comunicação, Social Media Core
