---
id: "POS-032"
name: "Diretor Geral de Geração e Transmissão"
type: "Position"
...
# Diretor Geral de Geração e Transmissão (ID: POS-032)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Diretor Geral de Geração e Transmissão** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Diretor Geral de Geração e Transmissão** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Liderança executiva do portfólio físico e operacional de usinas de geração e linhas de transmissão de alta tensão do grupo.
...
*   **Organização de Pertencimento (Parent Team/BU):** [/organizations/legal-entities/get-geracao-transmissao.md](Geração e Transmissão S.A.)
*   **Sistemas e Aplicações Utilizados (How):** GMS, EMS, SAP S/4HANA
