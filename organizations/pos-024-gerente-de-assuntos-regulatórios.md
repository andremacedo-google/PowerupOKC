---
id: "POS-024"
name: "Gerente de Assuntos Regulatórios"
type: "Position"
...
# Gerente de Assuntos Regulatórios (ID: POS-024)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Gerente de Assuntos Regulatórios** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Gerente de Assuntos Regulatórios** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Coordenar a interface e o relacionamento do grupo com a ANEEL, monitorando novas resoluções, revisões e reajustes tarifários anuais.
...
*   **Organização de Pertencimento (Parent Team/BU):** [/organizations/teams/team-tarifas-receita.md](Tarifas e Receita)
*   **Sistemas e Aplicações Utilizados (How):** BI Regulatório, SAGER
