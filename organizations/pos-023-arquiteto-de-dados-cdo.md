...
# Arquiteto de Dados (CDO) (ID: POS-023)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Arquiteto de Dados (CDO)** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Arquiteto de Dados (CDO)** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Construir e modelar pipelines de dados analíticos unificados, governar o catálogo de metadados mestre de dados e sustentar o Data Mesh.
...
*   **Sistemas e Aplicações Utilizados (How):** Google Cloud BigQuery, Vertex AI
