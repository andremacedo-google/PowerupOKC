...
# Chief Risk Officer (CRO) (ID: POS-028)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Chief Risk Officer (CRO)** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Chief Risk Officer (CRO)** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Liderar a governança de riscos corporativos integrados (ERM), compliance SOX e auditorias preventivas de conformidade no grupo.
...
*   **Sistemas e Aplicações Utilizados (How):** ServiceNow GRC, SAP GRC
