---
id: "POS-021"
name: "Gerente de Operacoes de TI (ITOps)"
type: "Position"
...
# Gerente de Operacoes de TI (ITOps) (ID: POS-021)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Gerente de Operacoes de TI (ITOps)** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Gerente de Operacoes de TI (ITOps)** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Supervisionar a sustentação, infraestrutura em nuvem, central de chamados, e garantir a alta disponibilidade operacional dos sistemas ERP/CIS.
...
*   **Organização de Pertencimento (Parent Team/BU):** [/organizations/teams/team-dados-ti.md](Escritório de Dados & TI)
*   **Sistemas e Aplicações Utilizados (How):** ServiceNow (ITSM/ITOM)
