---
id: "POS-019"
name: "Analista de M&A e Startups"
type: "Position"
...
# Analista de M&A e Startups (ID: POS-019)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Analista de M&A e Startups** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Analista de M&A e Startups** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Elaborar modelagens econômico-financeiras (VPL, TIR), realizar valuation de ativos de energia de interesse societário e auditorias de M&A.
...
*   **Organização de Pertencimento (Parent Team/BU):** [/organizations/teams/team-estrategia-novos-negocios.md](Estratégia e Novos Negócios)
*   **Sistemas e Aplicações Utilizados (How):** Valuation Tools, Excel
