...
# Diretor de Suprimentos (ID: POS-030)

Este Fact Sheet de **Position** descreve conceitualmente a estrutura, responsabilidade, atribuições e sistemas integrados associados à posição típica de **Diretor de Suprimentos** no ecossistema de informações do Setor Elétrico Brasileiro. Ele atua como elemento unificado do metamodelo SAP LeanIX v4.

## 1. Escopo de Negócio e Descrição
O cargo de **Diretor de Suprimentos** desempenha um papel central dentro da área funcional da companhia. No contexto do setor elétrico brasileiro, esta posição é fundamental para garantir a estabilidade operacional, conformidade regulatória com as normas da ANEEL, CCEE ou do ONS, e apoiar a transição e automação de processos.

## 2. Atividades e Responsabilidades Principais
*   Definir a estratégia geral de suprimentos, políticas de compras corporativas para grandes CAPEX de obras e homologação de grandes fornecedores.
...
*   **Sistemas e Aplicações Utilizados (How):** SAP Ariba, Coupa
