---
id: IND-024
name: "DFP - Desempenho da Frequência em Regime Permanente"
...
# DFP - Desempenho da Frequência em Regime Permanente (ID: IND-024)

Este Fact Sheet descreve o indicador de desempenho **DFP** (Desempenho da Frequência em Regime Permanente) integrado ao catálogo mestre da **PowerUp OKC (Open Knowledge Catalog)**. Ele atua como uma métrica de controle de governança em total conformidade com as diretrizes do metamodelo v4 da **SAP LeanIX**.

## 1. Descrição Geral e Metodologia de Medição
Mapeia continuamente o desvio e a estabilização da frequência do sistema interconectado (SIN) em regime permanente dentro de limites estritos definidos pelos Procedimentos de Rede.
...
*   **Limite Vigente:** `Faixa de controle: 59.9 Hz a 60.1 Hz`
...
*   **Data Object de Entrada (What):** [Fluxo de Potência](/data-objects/do-115-fluxo-de-potencia.md)
