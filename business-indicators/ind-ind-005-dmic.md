---
id: IND-005
name: "DMIC - Duração Máxima de Interrupção Contínua por Unidade Consumidora"
...
# DMIC - Duração Máxima de Interrupção Contínua por Unidade Consumidora (ID: IND-005)

Este Fact Sheet descreve o indicador de desempenho **DMIC** (Duração Máxima de Interrupção Contínua por Unidade Consumidora) integrado ao catálogo mestre da **PowerUp OKC (Open Knowledge Catalog)**. Ele atua como uma métrica de controle de governança em total conformidade com as diretrizes do metamodelo v4 da **SAP LeanIX**.

## 1. Descrição Geral e Metodologia de Medição
Mede a maior duração individualizada de uma única interrupção contínua de fornecimento de energia elétrica sofrida pela unidade consumidora no mês civil, obrigando compensação se ultrapassar os limites regulados pela ANEEL.
