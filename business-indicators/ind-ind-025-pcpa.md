---
id: IND-025
name: "PCPA - Pontualidade de Providências pós-Distúrbios"
...
# PCPA - Pontualidade de Providências pós-Distúrbios (ID: IND-025)

Este Fact Sheet descreve o indicador de desempenho **PCPA** (Pontualidade de Providências pós-Distúrbios) integrado ao catálogo mestre da **PowerUp OKC (Open Knowledge Catalog)**. Ele atua como uma métrica de controle de governança em total conformidade com as diretrizes do metamodelo v4 da **SAP LeanIX**.

## 1. Descrição Geral e Metodologia de Medição
Calcula a aderência e a pontualidade dos agentes proprietários na entrega e implementação dos planos de providência e recomendações técnicas emitidas pelo ONS após falhas (RAPs).
...
*   **Limite Vigente:** `Prazo regulatório do ONS`
*   **Regulador / Framework Principal:** ONS (Procedimentos de Rede)
*   **Unidade de Medida:** `% de metas`
...
*   **System of Truth / Application de Suporte:** [ServiceNow (ITSM)](/business-applications/app-itsm-gestao-servicos-ti.md)
*   **Organização / Time Proprietário (Who):** [Regulação e Receita](/organizations/teams/org-tarifas-receita.md)
*   **Data Object de Entrada (What):** [Lançamento (Release)](/data-objects/do-178-lancamento-release.md)
