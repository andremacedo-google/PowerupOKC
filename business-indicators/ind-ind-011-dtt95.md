---
id: IND-011
name: "DTT95 - Distorção Harmônica Total de Tensão"
...
# DTT95 - Distorção Harmônica Total de Tensão (ID: IND-011)

Este Fact Sheet descreve o indicador de desempenho **DTT95** (Distorção Harmônica Total de Tensão) integrado ao catálogo mestre da **PowerUp OKC (Open Knowledge Catalog)**. Ele atua como uma métrica de controle de governança em total conformidade com as diretrizes do metamodelo v4 da **SAP LeanIX**.

## 1. Descrição Geral e Metodologia de Medição
Deformação acumulada da onda senoidal de tensão em relação à senóide fundamental (soma das ordens harmônicas) superada em até 5% do tempo de monitoramento contínuo.
...
*   **Limite Vigente:** `10.0% (Vn<=2.3kV) / 8.0% (MT)`
