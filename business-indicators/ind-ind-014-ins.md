---
id: IND-014
name: "INS - Nível de Serviço do Teleatendimento"
...
# INS - Nível de Serviço do Teleatendimento (ID: IND-014)

Este Fact Sheet descreve o indicador de desempenho **INS** (Nível de Serviço do Teleatendimento) integrado ao catálogo mestre da **PowerUp OKC (Open Knowledge Catalog)**. Ele atua como uma métrica de controle de governança em total conformidade com as diretrizes do metamodelo v4 da **SAP LeanIX**.

## 1. Descrição Geral e Metodologia de Medição
Razão percentual entre chamadas atendidas em até 30 segundos pelas centrais de teleatendimento e o total de chamadas oferecidas e recebidas, descontadas as de abandono rápido.
...
*   **Limite Vigente:** `INS >= 85% em até 30s`
...
*   **Business Capability Medida (Nível 3):** [/cap-l3-atendimento-ao-cliente-multicanal](Atendimento ao Cliente Multicanal)
