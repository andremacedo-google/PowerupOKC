...
# Marketing Digital (CAP-L3-019)

Esta capacidade técnica detalhada de Nível 3 faz parte do grupo funcional **Marketing e Desenvolvimento de Novos Negócios** sob a área principal de **Engajamento com o Cliente** no Mapa de Capacidades do Setor de Energia.

---

## 1. Descrição Geral da Capacidade
A capacidade **Marketing Digital** rege o controle e a operação das atividades granulares de utilities relacionadas ao seu escopo. No contexto do setor elétrico brasileiro, ela é fundamental para a transição para uma rede mais conectada, sustentável e eficiente, alinhada com as macrotendências de Descarbonização, Descentralização e Digitalização (3Ds).
...
*   **Agente Sugerido:** Creative Campaign Asset Generator
*   **Classificação Arquitetural:** No-code (Agent Designer)
*   **Papel Operacional & Integrações:** Atua na redação de peças publicitárias, copies e na engenharia de prompts visuais para geração de banners de campanha.
...
*   **Inputs e Base de Conhecimento Requeridos:** Briefing de Campanha, Guias de Identidade Visual da Marca, Slogans Anteriores.
*   **Saída Esperada do Processo:** Copies Publicitários Otimizados, Prompts Estruturados para Geração de Imagens e Vídeos.
...
*   **Parent Capability (Nível 2):** [/business-capabilities/engajamento-com-o-cliente/marketing-e-desenvolvimento-de-novos-negocios/index.md](Marketing e Desenvolvimento de Novos Negócios)
*   **Parent Capability (Nível 1):** [/business-capabilities/engajamento-com-o-cliente/index.md](Engajamento com o Cliente)
*   **Supported by (Applications):** [/applications/creative-campaign-asset-generator.md](Creative Campaign Asset Generator)
*   **Associated Data Objects:** [/data-objects/briefing-de-campanha.md](Briefing de Campanha, Guias de Identidade Visual da Marca, Slogans Anteriores.)
