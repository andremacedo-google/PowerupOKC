---
id: CAP-L3-016
name: "Gestão de Estoques e Logística"
...
# Gestão de Estoques e Logística (CAP-L3-016)
...
*   **Agente Sugerido:** MRO Inventory & Logistics Optimizer
*   **Classificação Arquitetural:** Data Agent (Conversational Analytics)
*   **Papel Operacional & Integrações:** Analisa dados de estoque e logística de materiais para otimizar os níveis de componentes e infraestrutura de rede.
...
*   **Inputs e Base de Conhecimento Requeridos:** Níveis de Estoque de MRO, Dados de Demanda Histórica, Lead Time de Fornecedores de Peças.
*   **Saída Esperada do Processo:** Sugestões de Reposição e Níveis de Estoque Ideais, Planos de Abastecimento Regional.
...
*   **Supported by (Applications):** [/applications/mro-inventory-logistics-optimizer.md](MRO Inventory & Logistics Optimizer)
*   **Associated Data Objects:** [/data-objects/niveis-de-estoque-de-mro.md](Níveis de Estoque de MRO, Dados de Demanda Histórica, Lead Time de Fornecedores de Peças.)
