---
id: CAP-L3-006
name: "Desenvolvimento e Treinamento"
...
# Desenvolvimento e Treinamento (CAP-L3-006)
...
*   **Agente Sugerido:** Curador de Trilhas de Aprendizado e L&D
*   **Classificação Arquitetural:** No-code (Agent Designer)
*   **Papel Operacional & Integrações:** Analisa gaps de habilidades das equipes e gera recomendações automatizadas de trilhas de capacitação sobre novas tecnologias.
...
*   **Inputs e Base de Conhecimento Requeridos:** Matriz de Gaps de Habilidades, Catálogo de Cursos Corporativos, Planos de Carreira e L&D.
*   **Saída Esperada do Processo:** Recomendações Personalizadas de Trilhas de Estudo, Planos de Desenvolvimento Individual (PDI).
...
*   **Supported by (Applications):** [/applications/curador-de-trilhas-de-aprendizado-e-ld.md](Curador de Trilhas de Aprendizado e L&D)
*   **Associated Data Objects:** [/data-objects/matriz-de-gaps-de-habilidades.md](Matriz de Gaps de Habilidades, Catálogo de Cursos Corporativos, Planos de Carreira e L&D.)
