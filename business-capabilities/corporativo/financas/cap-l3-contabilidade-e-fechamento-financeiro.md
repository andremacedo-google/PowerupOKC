---
id: CAP-L3-003
name: "Contabilidade e Fechamento Financeiro"
...
# Contabilidade e Fechamento Financeiro (CAP-L3-003)
...
*   **Agente Sugerido:** Close Checklist Orchestrator & Anomalias
*   **Classificação Arquitetural:** Data Agent (Conversational Analytics)
*   **Papel Operacional & Integrações:** Monitora lançamentos contábeis, automatiza conciliações e detecta inconsistências em lote para acelerar o fechamento de mês.
...
*   **Inputs e Base de Conhecimento Requeridos:** Razão Contábil, Balancetes de Verificação, Regras de Conciliação Contábil, Lançamentos Diários.
*   **Saída Esperada do Processo:** Alertas de Lançamentos Anômalos, Checklist Automatizado de Pendências do Fechamento Mensal.
...
*   **Supported by (Applications):** [/applications/close-checklist-orchestrator-anomalias.md](Close Checklist Orchestrator & Anomalias)
*   **Associated Data Objects:** [/data-objects/razao-contabil.md](Razão Contábil, Balancetes de Verificação, Regras de Conciliação Contábil, Lançamentos Diários.)
