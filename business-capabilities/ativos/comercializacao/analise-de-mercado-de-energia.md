---
id: CAP-L3-038
name: "Análise de Mercado de Energia"
...
# Análise de Mercado de Energia (CAP-L3-038)
...
*   **Agente Sugerido:** Previsor de PLD e Oferta de Energia
*   **Classificação Arquitetural:** Data Agent (Conversational Analytics)
*   **Papel Operacional & Integrações:** Processa dados meteorológicos, de bacias hidrográficas e preços da CCEE/ONS para estimar a formação do PLD.
...
*   **Inputs e Base de Conhecimento Requeridos:** Dados Meteorológicos Históricos, Vazões de Bacias Hidrográficas, Dados Históricos do PLD (CCEE).
*   **Saída Esperada do Processo:** Projeções Preditivas de PLD e de Margens de Oferta e Demanda de Energia.
...
*   **Supported by (Applications):** [/applications/previsor-de-pld-e-oferta-de-energia.md](Previsor de PLD e Oferta de Energia)
*   **Associated Data Objects:** [/data-objects/dados-meteorologicos-historicos.md](Dados Meteorológicos Históricos, Vazões de Bacias Hidrográficas, Dados Históricos do PLD (CCEE).)
